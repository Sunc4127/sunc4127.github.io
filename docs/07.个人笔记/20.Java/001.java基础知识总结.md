---
title: java基础知识总结
date: 2021-11-23 17:19:04
permalink: /pages/c52bcc/
categories:
  - 个人笔记
  - Java
tags:
...
![](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043248.png)
...
<img src="https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043405.png" alt="java程序转变为机器代码的过程" style="zoom: 67%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111231735277.png" alt="编译型语言和解释型语言" style="zoom:67%;" />
...
![](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043633.png)
...
- Java 的类是单继承的，C++ 支持多重继承；虽然 Java 的类不可以多继承，但是接口（interface）可以多继承。
...
`String` 中的 `equals` 方法是被重写过的，因为 `Object` 的 `equals` 方法是比较的对象的内存地址，而 `String` 的 `equals` 方法比较的是对象的值。（所以对比 String 的时候，最好用 `equals`）
...
1. 6 种数字类型 ：
    1. 4 种整数类型: `byte`、`short`、`int`、`long`、
    2. 2 种浮点数类型: `float`、`double`

2. 1 种字符类型：`char` (表示单个字符， Java 使用统一码对字符进行编码)
3. 1 种布尔型：`boolean`。
...
![](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043764.png)
...
![example 1 ](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043850.jpg)
...
![](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043001.jpg)

交换之后：

![](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043086.jpg)
...
![](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043882.jpg)
...
![deep and shallow copy](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043892.jpg)
...
![](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043111.png)
...
![check-exception](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043302.png)
...
![](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043502.png)
...
![IO-操作对象分类](https://cdn.jsdelivr.net/gh/Sunc4127/image-hosting/202111241043745.png)
